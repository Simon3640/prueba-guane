...
from app.api.v1.routes import user, expense, expense_category, income, income_category, auth
...
api_route.include_router(income_category.router, prefix='/income-category', tags=['income-category'])
